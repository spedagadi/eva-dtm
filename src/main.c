...
/*static void apply_target_contrast(struct priv *p, struct pl_color_space
*color)
{
...
int main(int argc, char *argv[]) {
  ...
  // state.force_hdr_enable = false;
  // state.force_prim =
  // PL_COLOR_PRIM_BT_2020;//PL_COLOR_PRIM_BT_709;//PL_COLOR_PRIM_BT_2020;
  //  #if defined(WIN32)
