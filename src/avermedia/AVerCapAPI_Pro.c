...
LONG WINAPI AVerInitialize()
{
	...
	dll_Fun=(DLL_AVerInitialize)GetProcAddress(m_hdll,"AVerInitialize");
	if(dll_Fun==NULL)
	{
...
LONG WINAPI AVerUninitialize()
{
	...
	dll_Fun=(DLL_AVerUninitialize)GetProcAddress(m_hdll,"AVerUninitialize");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetDeviceNum(DWORD *pdwDeviceNum)
{
	...
	dll_Fun=(DLL_AVerGetDeviceNum)GetProcAddress(m_hdll,"AVerGetDeviceNum");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetDeviceType(DWORD dwDeviceIndex, DWORD *pdwDeviceType)
{
	...
	dll_Fun=(DLL_AVerGetDeviceType)GetProcAddress(m_hdll,"AVerGetDeviceType");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetDeviceName(DWORD dwDeviceIndex, LPWSTR szDeviceName)
{
	...
	dll_Fun=(DLL_AVerGetDeviceName)GetProcAddress(m_hdll,"AVerGetDeviceName");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetDeviceSerialNum(DWORD dwDeviceIndex, BYTE *pbySerialNum)
{
	...
	dll_Fun=(DLL_AVerGetDeviceSerialNum)GetProcAddress(m_hdll,"AVerGetDeviceSerialNum");
	if(dll_Fun==NULL)
	{
...
LONG WINAPI AVerCreateCaptureObject(DWORD dwDeviceIndex, HWND hWnd, HANDLE *phCaptureObject)
{
	...
	dll_Fun=(DLL_AVerCreateCaptureObject)GetProcAddress(m_hdll,"AVerCreateCaptureObject");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCreateCaptureObjectEx(DWORD dwDeviceIndex, DWORD dwType, HWND hWnd, HANDLE *phCaptureObject)
{
	...
	dll_Fun=(DLL_AVerCreateCaptureObjectEx)GetProcAddress(m_hdll,"AVerCreateCaptureObjectEx");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerDeleteCaptureObject(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerDeleteCaptureObject)GetProcAddress(m_hdll,"AVerDeleteCaptureObject");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoSourceSupported(HANDLE hCaptureObject,DWORD *pdwSupported, DWORD *pdwNum)
{
	...
	dll_Fun=(DLL_AVerGetVideoSourceSupported)GetProcAddress(m_hdll,"AVerGetVideoSourceSupported");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoSource(HANDLE hCaptureObject, DWORD dwVideoSource)
{
	...
	dll_Fun=(DLL_AVerSetVideoSource)GetProcAddress(m_hdll,"AVerSetVideoSource");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoSource(HANDLE hCaptureObject, DWORD *pdwVideoSource)
{
	...
	dll_Fun=(DLL_AVerGetVideoSource)GetProcAddress(m_hdll,"AVerGetVideoSource");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioSourceSupportedEx(HANDLE hCaptureObject, DWORD dwVideoSource, DWORD *pdwSupported)
{
	...
	dll_Fun=(DLL_AVerGetAudioSourceSupportedEx)GetProcAddress(m_hdll,"AVerGetAudioSourceSupportedEx");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetAudioSource(HANDLE hCaptureObject, DWORD dwAudioSource)
{
	...
	dll_Fun=(DLL_AVerSetAudioSource)GetProcAddress(m_hdll,"AVerSetAudioSource");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioSource(HANDLE hCaptureObject, DWORD *pdwAudioSource)
{
	...
	dll_Fun=(DLL_AVerGetAudioSource)GetProcAddress(m_hdll,"AVerGetAudioSource");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoFormat(HANDLE hCaptureObject, DWORD dwVideoFormat)
{
	...
	dll_Fun=(DLL_AVerSetVideoFormat)GetProcAddress(m_hdll,"AVerSetVideoFormat");
	if(dll_Fun==NULL)
	{ 
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoFormat(HANDLE hCaptureObject, DWORD *pdwVideoFormat)
{
	...
	dll_Fun = (DLL_AVerGetVideoFormat)GetProcAddress(m_hdll, "AVerGetVideoFormat");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoResolutionRangeSupported(HANDLE hCaptureObject, DWORD dwVideoSource,DWORD dwFormat,RESOLUTION_RANGE_INFO *ResolutionRangeInfo)
{
	...
	dll_Fun = (DLL_AVerGetVideoResolutionRangeSupported)GetProcAddress(m_hdll, "AVerGetVideoResolutionRangeSupported");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoResolutionSupported(HANDLE hCaptureObject,DWORD dwVideoSource,DWORD dwVideoFormat, DWORD *pdwSupported, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerGetVideoResolutionSupported)GetProcAddress(m_hdll, "AVerGetVideoResolutionSupported");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoResolutionEx(HANDLE hCaptureObject, VIDEO_RESOLUTION *pVideoResolution)
{
	...
	dll_Fun = (DLL_AVerSetVideoResolutionEx)GetProcAddress(m_hdll, "AVerSetVideoResolutionEx");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoResolutionEx(HANDLE hCaptureObject, VIDEO_RESOLUTION *pVideoResolution)
{
	...
	dll_Fun = (DLL_AVerGetVideoResolutionEx)GetProcAddress(m_hdll, "AVerGetVideoResolutionEx");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoInputFrameRateRangeSupported(HANDLE hCaptureObject, DWORD dwVideoSource, DWORD dwFormat, DWORD dwWidth, DWORD dwHeight, FRAMERATE_RANGE_INFO *FrameRateRangeInfo)
{
	...
	dll_Fun = (DLL_AVerGetVideoInputFrameRateRangeSupported)GetProcAddress(m_hdll, "AVerGetVideoInputFrameRateRangeSupported");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoInputFrameRateSupportedEx(HANDLE hCaptureObject, DWORD dwVideoSource,DWORD dwVideoFormat, DWORD dwVideoResolution, DWORD *pdwSupported, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerGetVideoInputFrameRateSupportedEx)GetProcAddress(m_hdll, "AVerGetVideoInputFrameRateSupportedEx");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoInputFrameRate(HANDLE hCaptureObject, DWORD dwFrameRate)
{
	...
	dll_Fun = (DLL_AVerSetVideoInputFrameRate)GetProcAddress(m_hdll, "AVerSetVideoInputFrameRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoInputFrameRate(HANDLE hCaptureObject, DWORD *pdwFrameRate)
{
	...
	dll_Fun = (DLL_AVerGetVideoInputFrameRate)GetProcAddress(m_hdll, "AVerGetVideoInputFrameRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioSamplingRateSupported(HANDLE hCaptureObject, DWORD dwAudioSource,DWORD *pdwSupported, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerGetAudioSamplingRateSupported)GetProcAddress(m_hdll, "AVerGetAudioSamplingRateSupported");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetAudioSamplingRate(HANDLE hCaptureObject, DWORD dwSamplingRate)
{
	...
	dll_Fun = (DLL_AVerSetAudioSamplingRate)GetProcAddress(m_hdll, "AVerSetAudioSamplingRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioSamplingRate(HANDLE hCaptureObject, DWORD *pdwSamplingRate)
{
	...
	dll_Fun = (DLL_AVerGetAudioSamplingRate)GetProcAddress(m_hdll, "AVerGetAudioSamplingRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStartStreaming(HANDLE hCaptureObject)
{
	...
	dll_Fun = (DLL_AVerStartStreaming)GetProcAddress(m_hdll, "AVerStartStreaming");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStopStreaming(HANDLE hCaptureObject)
{
	...
	dll_Fun = (DLL_AVerStopStreaming)GetProcAddress(m_hdll, "AVerStopStreaming");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioInfo(HANDLE hCaptureObject, INPUT_AUDIO_INFO *pAudioInfo)
{
	...
	dll_Fun = (DLL_AVerGetAudioInfo)GetProcAddress(m_hdll, "AVerGetAudioInfo");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoInfo(HANDLE hCaptureObject, INPUT_VIDEO_INFO *pVideoInfo)
{
	...
	dll_Fun = (DLL_AVerGetVideoInfo)GetProcAddress(m_hdll, "AVerGetVideoInfo");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMacroVisionMode(HANDLE hCaptureObject, DWORD *pdwMode)
{
	...
	dll_Fun = (DLL_AVerGetMacroVisionMode)GetProcAddress(m_hdll, "AVerGetMacroVisionMode");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetSignalPresence(HANDLE hCaptureObject, BOOL *pbSignalPresence)
{
	...
	dll_Fun = (DLL_AVerGetSignalPresence)GetProcAddress(m_hdll, "AVerGetSignalPresence");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerEnumThirdPartyAudioCapSource(HANDLE hCaptureObject, AUDIOCAPTURESOURCE_INFO *pAudioCapSourceInfo, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerEnumThirdPartyAudioCapSource)GetProcAddress(m_hdll, "AVerEnumThirdPartyAudioCapSource");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerEnumThirdPartyAudioCapSourceInputType(HANDLE hCaptureObject, DWORD dwCapIndex, AUDIOCAPTURESOURCE_INPUTTYPE_INFO *pInputTypeInfo, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerEnumThirdPartyAudioCapSourceInputType)GetProcAddress(m_hdll, "AVerEnumThirdPartyAudioCapSourceInputType");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerEnumThirdPartyAudioCapSourceSampleFormat(HANDLE hCaptureObject, DWORD dwCapIndex, AUDIOCAPTURESOURCE_FORMAT_INFO *pFormatInfo, DWORD *pdwNum)
{
	...
	dll_Fun = (DLL_AVerEnumThirdPartyAudioCapSourceSampleFormat)GetProcAddress(m_hdll, "AVerEnumThirdPartyAudioCapSourceSampleFormat");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetThirdPartyAudioCapSource(HANDLE hCaptureObject, AUDIOCAPTURESOURCE_SETTING *pAudioCapSourceSetting)
{
	...
	dll_Fun = (DLL_AVerSetThirdPartyAudioCapSource)GetProcAddress(m_hdll, "AVerSetThirdPartyAudioCapSource");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetThirdPartyAudioCapSource(HANDLE hCaptureObject, AUDIOCAPTURESOURCE_SETTING *pAudioCapSourceSetting)
{
	...
	dll_Fun = (DLL_AVerGetThirdPartyAudioCapSource)GetProcAddress(m_hdll, "AVerGetThirdPartyAudioCapSource");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoWindowPosition(HANDLE hCaptureObject, RECT rectVideoWnd)
{
	...
	dll_Fun = (DLL_AVerSetVideoWindowPosition)GetProcAddress(m_hdll, "AVerSetVideoWindowPosition");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerRepaintVideo(HANDLE hCaptureObject)
{
	...
	dll_Fun = (DLL_AVerRepaintVideo)GetProcAddress(m_hdll, "AVerRepaintVideo");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoRenderer(HANDLE hCaptureObject, DWORD dwVideoRenderer)
{
	...
	dll_Fun = (DLL_AVerSetVideoRenderer)GetProcAddress(m_hdll, "AVerSetVideoRenderer");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoRenderer(HANDLE hCaptureObject, DWORD *pdwVideoRenderer)
{
	...
	dll_Fun = (DLL_AVerGetVideoRenderer)GetProcAddress(m_hdll, "AVerGetVideoRenderer");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetMaintainAspectRatioEnabled(HANDLE hCaptureObject, BOOL bEnabled)
{
	...
	dll_Fun = (DLL_AVerSetMaintainAspectRatioEnabled)GetProcAddress(m_hdll, "AVerSetMaintainAspectRatioEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMaintainAspectRatioEnabled(HANDLE hCaptureObject, BOOL *pbEnabled)
{
	...
	dll_Fun = (DLL_AVerGetMaintainAspectRatioEnabled)GetProcAddress(m_hdll, "AVerGetMaintainAspectRatioEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAspectRatio(HANDLE hCaptureObject, DWORD *pdwAspectRatioX, DWORD *pdwAspectRatioY)
{
	...
	dll_Fun = (DLL_AVerGetAspectRatio)GetProcAddress(m_hdll, "AVerGetAspectRatio");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoPreviewEnabled(HANDLE hCaptureObject, BOOL bEnabled)
{
	...
	dll_Fun = (DLL_AVerSetVideoPreviewEnabled)GetProcAddress(m_hdll, "AVerSetVideoPreviewEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoPreviewEnabled(HANDLE hCaptureObject, BOOL *pbEnabled)
{
	...
	dll_Fun = (DLL_AVerGetVideoPreviewEnabled)GetProcAddress(m_hdll, "AVerGetVideoPreviewEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetAudioPreviewEnabled(HANDLE hCaptureObject, BOOL bEnabled)
{
	...
	dll_Fun = (DLL_AVerSetAudioPreviewEnabled)GetProcAddress(m_hdll, "AVerSetAudioPreviewEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioPreviewEnabled(HANDLE hCaptureObject, BOOL *pbEnabled)
{
	...
	dll_Fun = (DLL_AVerGetAudioPreviewEnabled)GetProcAddress(m_hdll, "AVerGetAudioPreviewEnabled");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVolume(HANDLE hCaptureObject, DWORD dwVolumeMode, DWORD dwVolume)
{
	...
	dll_Fun = (DLL_AVerSetVolume)GetProcAddress(m_hdll, "AVerSetVolume");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVolume(HANDLE hCaptureObject, DWORD dwVolumeMode, DWORD *pdwVolume)
{
	...
	dll_Fun = (DLL_AVerGetVolume)GetProcAddress(m_hdll, "AVerGetVolume");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoProcAmp(HANDLE hCaptureObject, DWORD dwVideoProcAmpProperty, DWORD dwPropertyValue)
{
	...
	dll_Fun = (DLL_AVerSetVideoProcAmp)GetProcAddress(m_hdll, "AVerSetVideoProcAmp");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoProcAmp(HANDLE hCaptureObject, DWORD dwVideoProcAmpProperty, DWORD *pdwPropertyValue)
{
	...
	dll_Fun = (DLL_AVerGetVideoProcAmp)GetProcAddress(m_hdll, "AVerGetVideoProcAmp");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoOutputFrameRate(HANDLE hCaptureObject, DWORD dwFrameRate)
{
	...
	dll_Fun = (DLL_AVerSetVideoOutputFrameRate)GetProcAddress(m_hdll, "AVerSetVideoOutputFrameRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoOutputFrameRate(HANDLE hCaptureObject, DWORD *pdwFrameRate)
{
	...
	dll_Fun = (DLL_AVerGetVideoOutputFrameRate)GetProcAddress(m_hdll, "AVerGetVideoOutputFrameRate");
	if (dll_Fun == NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
{	
	...
	dll_Fun=(DLL_AVerSetDeinterlaceMode)GetProcAddress(m_hdll,"AVerSetDeinterlaceMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetDeinterlaceMode(HANDLE hCaptureObject, DWORD* pdwMode)
{
	...
	dll_Fun=(DLL_AVerGetDeinterlaceMode)GetProcAddress(m_hdll,"AVerGetDeinterlaceMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoDownscaleMode(HANDLE hCaptureObject, DWORD dwMode, DWORD dwWidth, DWORD dwHeight)
{
	...
	dll_Fun=(DLL_AVerSetVideoDownscaleMode)GetProcAddress(m_hdll,"AVerSetVideoDownscaleMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoDownscaleMode(HANDLE hCaptureObject, DWORD *pdwMode, DWORD *pdwWidth, DWORD *pdwHeight)
{
	...
	dll_Fun=(DLL_AVerGetVideoDownscaleMode)GetProcAddress(m_hdll,"AVerGetVideoDownscaleMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetOverlayProperty(HANDLE hCaptureObject, DWORD dwContentType, OVERLAY_INFO OverlayInfo)
{
	...
	dll_Fun=(DLL_AVerSetOverlayProperty)GetProcAddress(m_hdll,"AVerSetOverlayProperty");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetOverlayProperty(HANDLE hCaptureObject, DWORD dwContentType, OVERLAY_INFO *pOverlayInfo)
{
	...
	dll_Fun=(DLL_AVerGetOverlayProperty)GetProcAddress(m_hdll,"AVerGetOverlayProperty");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayText(HANDLE hCaptureObject, LPWSTR lpText, DWORD dwDuration)
{
	...
	dll_Fun=(DLL_AVerOverlayText)GetProcAddress(m_hdll,"AVerOverlayText");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayTextEx(HANDLE hCaptureObject, CAP_OVERLAY_TEXT_INFO* pCapOverlayTextInfo)
{
	...
	dll_Fun=(DLL_AVerOverlayTextEx)GetProcAddress(m_hdll,"AVerOverlayTextEx");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayTime(HANDLE hCaptureObject, DWORD dwFormat, DWORD dwDuration)
{
	...
	dll_Fun=(DLL_AVerOverlayTime)GetProcAddress(m_hdll,"AVerOverlayTime");
	if(dll_Fun==NULL)
	{ 
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayImage(HANDLE hCaptureObject, OVERLAY_IMAGE_INFO ImageInfo, DWORD dwDuration)
{
	...
	dll_Fun=(DLL_AVerOverlayImage)GetProcAddress(m_hdll,"AVerOverlayImage");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayMediaContent(HANDLE hCaptureObject, OVERLAY_CONTENT_INFO* pContentInfo)
{
	...
	dll_Fun=(DLL_AVerOverlayMediaContent)GetProcAddress(m_hdll,"AVerOverlayMediaContent");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayDC(HANDLE hCaptureObject, OVERLAY_DC_INFO* pOverlayDCInfo)
{
	...
	dll_Fun=(DLL_AVerOverlayDC)GetProcAddress(m_hdll,"AVerOverlayDC");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetNoiseReductionEnabled(HANDLE hCaptureObject, BOOL bEnabled)
{
	...
	dll_Fun=(DLL_AVerSetNoiseReductionEnabled)GetProcAddress(m_hdll,"AVerSetNoiseReductionEnabled");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetNoiseReductionEnabled(HANDLE hCaptureObject, BOOL *pbEnabled)
{
	...
	dll_Fun=(DLL_AVerGetNoiseReductionEnabled)GetProcAddress(m_hdll,"AVerGetNoiseReductionEnabled");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoStreamMixingProperty(HANDLE hCaptureObject, DWORD dwStreamID, VIDEO_STREAM_INFO VideoStreamInfo)
{
	...
	dll_Fun=(DLL_AVerSetVideoStreamMixingProperty)GetProcAddress(m_hdll,"AVerSetVideoStreamMixingProperty");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoStreamMixingProperty(HANDLE hCaptureObject, DWORD dwStreamID, VIDEO_STREAM_INFO *pVideoStreamInfo)
{
	...
	dll_Fun=(DLL_AVerGetVideoStreamMixingProperty)GetProcAddress(m_hdll,"AVerGetVideoStreamMixingProperty");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerMixVideoStream(HANDLE hCaptureObject, DWORD dwStreamID, BYTE *pData, DWORD dwStride, LONG lLength, __int64 tRefTime, DWORD dwOptions)
{
	...
	dll_Fun=(DLL_AVerMixVideoStream)GetProcAddress(m_hdll,"AVerMixVideoStream");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoEnhanceMode(HANDLE hCaptureObject, DWORD dwMode)
{
	...
	dll_Fun=(DLL_AVerSetVideoEnhanceMode)GetProcAddress(m_hdll,"AVerSetVideoEnhanceMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoEnhanceMode(HANDLE hCaptureObject, DWORD *pdwMode)
{
	...
	dll_Fun=(DLL_AVerGetVideoEnhanceMode)GetProcAddress(m_hdll,"AVerGetVideoEnhanceMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoClippingRect(HANDLE hCaptureObject, RECT rcClippingRect)
{
	...
	dll_Fun=(DLL_AVerSetVideoClippingRect)GetProcAddress(m_hdll,"AVerSetVideoClippingRect");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoClippingRect(HANDLE hCaptureObject, RECT *prcClippingRect)
{
	...
	dll_Fun=(DLL_AVerGetVideoClippingRect)GetProcAddress(m_hdll,"AVerGetVideoClippingRect");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoMirrorMode(HANDLE hCaptureObject, DWORD dwMode)
{
	...
	dll_Fun=(DLL_AVerSetVideoMirrorMode)GetProcAddress(m_hdll,"AVerSetVideoMirrorMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoMirrorMode(HANDLE hCaptureObject, DWORD *pdwMode)
{
	...
	dll_Fun=(DLL_AVerGetVideoMirrorMode)GetProcAddress(m_hdll,"AVerGetVideoMirrorMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoRotateMode(HANDLE hCaptureObject, DWORD dwMode)
{
	...
	dll_Fun=(DLL_AVerSetVideoRotateMode)GetProcAddress(m_hdll,"AVerSetVideoRotateMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoRotateMode(HANDLE hCaptureObject, DWORD *pdwMode)
{
	...
	dll_Fun=(DLL_AVerGetVideoRotateMode)GetProcAddress(m_hdll,"AVerGetVideoRotateMode");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoUpscaleBlackRect(HANDLE hCaptureObject, RECT rcUpscaleRect)
{
	...
	dll_Fun=(DLL_AVerSetVideoUpscaleBlackRect)GetProcAddress(m_hdll,"AVerSetVideoUpscaleBlackRect");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoUpscaleBlackRect(HANDLE hCaptureObject, RECT *prcUpscaleRect)
{
	...
	dll_Fun=(DLL_AVerGetVideoUpscaleBlackRect)GetProcAddress(m_hdll,"AVerGetVideoUpscaleBlackRect");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerMotionDetection(HANDLE hCaptureObject, MOTION_DETECT_INFO *pMotionDetectInfo)
{
	...
	dll_Fun=(DLL_AVerMotionDetection)GetProcAddress(m_hdll,"AVerMotionDetection");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerPauseVideo(HANDLE hCaptureObject, BOOL bPause, DWORD dwOptions)
{
	...
	dll_Fun=(DLL_AVerPauseVideo)GetProcAddress(m_hdll,"AVerPauseVideo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureAudioSampleStart(HANDLE hCaptureObject, AUDIOPRCSCALLBACK lpCallback, LONGPTR lCallbackUserData)
{
	...
	dll_Fun=(DLL_AVerCaptureAudioSampleStart)GetProcAddress(m_hdll,"AVerCaptureAudioSampleStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureAudioSampleStartEx(HANDLE hCaptureObject, AUDIO_CAPTURE_INFO CaptureInfo)
{
	...
	dll_Fun=(DLL_AVerCaptureAudioSampleStartEx)GetProcAddress(m_hdll,"AVerCaptureAudioSampleStartEx");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureAudioSampleStop(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerCaptureAudioSampleStop)GetProcAddress(m_hdll,"AVerCaptureAudioSampleStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureImageStart(HANDLE hCaptureObject, CAPTURE_IMAGE_INFO *pCaptureImageInfo)
{
	...
	dll_Fun=(DLL_AVerCaptureImageStart)GetProcAddress(m_hdll,"AVerCaptureImageStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureImageStop(HANDLE hCaptureObject, DWORD dwImageType)
{
	...
	dll_Fun=(DLL_AVerCaptureImageStop)GetProcAddress(m_hdll,"AVerCaptureImageStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureSingleImage(HANDLE hCaptureObject, CAPTURE_SINGLE_IMAGE_INFO *pCaptureSingleImageInfo)
{
	...
	dll_Fun=(DLL_AVerCaptureSingleImage)GetProcAddress(m_hdll,"AVerCaptureSingleImage");
	if(dll_Fun==NULL)
	{ 
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureSingleImageToBuffer(HANDLE hCaptureObject, BYTE *lpBmpData, LONG *plBufferSize, BOOL bOverlayMix, DWORD dwTimeout)
{
	...
	dll_Fun=(DLL_AVerCaptureSingleImageToBuffer)GetProcAddress(m_hdll,"AVerCaptureSingleImageToBuffer");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureVideoSequenceStart(HANDLE hCaptureObject, VIDEO_CAPTURE_INFO CaptureInfo)
{
	...
	dll_Fun=(DLL_AVerCaptureVideoSequenceStart)GetProcAddress(m_hdll,"AVerCaptureVideoSequenceStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureVideoSequenceStop(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerCaptureVideoSequenceStop)GetProcAddress(m_hdll,"AVerCaptureVideoSequenceStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetAudioRecordEnabled(HANDLE hCaptureObject, BOOL bEnabled)
{
	...
	dll_Fun=(DLL_AVerSetAudioRecordEnabled)GetProcAddress(m_hdll,"AVerSetAudioRecordEnabled");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioRecordEnabled(HANDLE hCaptureObject, BOOL *pbEnabled)
{
	...
	dll_Fun=(DLL_AVerGetAudioRecordEnabled)GetProcAddress(m_hdll,"AVerGetAudioRecordEnabled");
	if(dll_Fun==NULL)
	{ 
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetMpeg2VideoEncoderInfo(HANDLE hCaptureObject, MPEG2_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetMpeg2VideoEncoderInfo)GetProcAddress(m_hdll,"AVerSetMpeg2VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMpeg2VideoEncoderInfo(HANDLE hCaptureObject, MPEG2_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetMpeg2VideoEncoderInfo)GetProcAddress(m_hdll,"AVerGetMpeg2VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetMpeg2AudioEncoderInfo(HANDLE hCaptureObject, MPEG2_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetMpeg2AudioEncoderInfo)GetProcAddress(m_hdll,"AVerSetMpeg2AudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMpeg2AudioEncoderInfo(HANDLE hCaptureObject, MPEG2_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetMpeg2AudioEncoderInfo)GetProcAddress(m_hdll,"AVerGetMpeg2AudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetHardwareVideoAccelerationCapabilities(HANDLE hCaptureObject, DWORD *pdwCapabilities)
{
	...
	dll_Fun=(DLL_AVerGetHardwareVideoAccelerationCapabilities)GetProcAddress(m_hdll,"AVerGetHardwareVideoAccelerationCapabilities");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetMpeg4VideoEncoderInfo(HANDLE hCaptureObject, MPEG4_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetMpeg4VideoEncoderInfo)GetProcAddress(m_hdll,"AVerSetMpeg4VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMpeg4VideoEncoderInfo(HANDLE hCaptureObject, MPEG4_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetMpeg4VideoEncoderInfo)GetProcAddress(m_hdll,"AVerGetMpeg4VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetMpeg4AudioEncoderInfo(HANDLE hCaptureObject, MPEG4_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetMpeg4AudioEncoderInfo)GetProcAddress(m_hdll,"AVerSetMpeg4AudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetMpeg4AudioEncoderInfo(HANDLE hCaptureObject, MPEG4_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetMpeg4AudioEncoderInfo)GetProcAddress(m_hdll,"AVerGetMpeg4AudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwSetVideoEncoderInfo(HANDLE hCaptureObject, HW_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerHwSetVideoEncoderInfo)GetProcAddress(m_hdll,"AVerHwSetVideoEncoderInfo");
	if(dll_Fun==NULL)
	{ 
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwGetVideoEncoderInfo(HANDLE hCaptureObject, HW_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerHwGetVideoEncoderInfo)GetProcAddress(m_hdll,"AVerHwGetVideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwSetAudioEncoderInfo(HANDLE hCaptureObject, HW_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerHwSetAudioEncoderInfo)GetProcAddress(m_hdll,"AVerHwSetAudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwGetAudioEncoderInfo(HANDLE hCaptureObject, HW_AUDIOENCODER_INFO *pAudioEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerHwGetAudioEncoderInfo)GetProcAddress(m_hdll,"AVerHwGetAudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwCaptureStreamStart(HANDLE hCaptureObject, HW_STREAM_CAPTURE_INFO *pCaptureInfo)
{
	...
	dll_Fun=(DLL_AVerHwCaptureStreamStart)GetProcAddress(m_hdll,"AVerHwCaptureStreamStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerHwCaptureStreamStop(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerHwCaptureStreamStop)GetProcAddress(m_hdll,"AVerHwCaptureStreamStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetEventCallback(HANDLE hCaptureObject, NOTIFYEVENTCALLBACK lpCallback, DWORD dwOptions, LPVOID lpUserData)
{
	...
	dll_Fun=(DLL_AVerSetEventCallback)GetProcAddress(m_hdll,"AVerSetEventCallback");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerTsCaptureStreamStart(HANDLE hCaptureObject, TS_STREAM_CAPTURE_INFO *pCaptureInfo)
{
	...
	dll_Fun=(DLL_AVerTsCaptureStreamStart)GetProcAddress(m_hdll,"AVerTsCaptureStreamStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerTsCaptureStreamStop(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerTsCaptureStreamStop)GetProcAddress(m_hdll,"AVerTsCaptureStreamStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerTsSetStreamCallback(HANDLE hCaptureObject, TS_STREAM_CALLBACK_INFO *pCallbackInfo)
{
	...
	dll_Fun=(DLL_AVerTsSetStreamCallback)GetProcAddress(m_hdll,"AVerTsSetStreamCallback");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetEmbeddedAudioChannel(HANDLE hCaptureObject, DWORD dwChannels)
{
	...
	dll_Fun=(DLL_AVerSetEmbeddedAudioChannel)GetProcAddress(m_hdll,"AVerSetEmbeddedAudioChannel");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetEmbeddedAudioChannel(HANDLE hCaptureObject, DWORD *pdwChannels)
{
	...
	dll_Fun=(DLL_AVerGetEmbeddedAudioChannel)GetProcAddress(m_hdll,"AVerGetEmbeddedAudioChannel");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoColorAdjustment(HANDLE hCaptureObject, VIDEO_COLOR_ADJUSTMENT *pVideoColorAdjustment)
{
	...
	dll_Fun=(DLL_AVerGetVideoColorAdjustment)GetProcAddress(m_hdll,"AVerGetVideoColorAdjustment");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoColorAdjustment(HANDLE hCaptureObject, VIDEO_COLOR_ADJUSTMENT *pVideoColorAdjustment)
{
	...
	dll_Fun=(DLL_AVerSetVideoColorAdjustment)GetProcAddress(m_hdll,"AVerSetVideoColorAdjustment");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerOverlayMarquee(HANDLE hCaptureObject, CAP_OVERLAY_MARQUEE_INFO *pVideoColorAdjustment)
{
	...
	dll_Fun=(DLL_AVerOverlayMarquee)GetProcAddress(m_hdll,"AVerOverlayMarquee");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioSpectrumInfo(HANDLE hCaptureObject, SPECTRUM_ANALYZE_INFO *pSpectrumInfo)
{
	...
	dll_Fun=(DLL_AVerGetAudioSpectrumInfo)GetProcAddress(m_hdll,"AVerGetAudioSpectrumInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAudioLoundnessInfo(HANDLE hCaptureObject, LOUDNESS_ANALYZE_INFO *pLoundnessInfo)
{
	...
	dll_Fun=(DLL_AVerGetAudioLoundnessInfo)GetProcAddress(m_hdll,"AVerGetAudioLoundnessInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetEncoderTypeInfo(HANDLE hCaptureObject, ENCODER_TYPE_INFO *pInfo)
{
	...
	dll_Fun=(DLL_AVerSetEncoderTypeInfo)GetProcAddress(m_hdll,"AVerSetEncoderTypeInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetEncoderTypeInfo(HANDLE hCaptureObject, ENCODER_TYPE_INFO *pInfo)
{
	...
	dll_Fun=(DLL_AVerGetEncoderTypeInfo)GetProcAddress(m_hdll,"AVerGetEncoderTypeInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoAccelerationCapabilities(HANDLE hCaptureObject, DWORD dwVideoEncoderType,DWORD *pdwCapabilities)
{
	...
	dll_Fun=(DLL_AVerGetVideoAccelerationCapabilities)GetProcAddress(m_hdll,"AVerGetVideoAccelerationCapabilities");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetH264VideoEncoderInfo(HANDLE hCaptureObject, H264_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetH264VideoEncoderInfo)GetProcAddress(m_hdll,"AVerSetH264VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetH264VideoEncoderInfo(HANDLE hCaptureObject, H264_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetH264VideoEncoderInfo)GetProcAddress(m_hdll,"AVerGetH264VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetH265VideoEncoderInfo(HANDLE hCaptureObject, H265_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetH265VideoEncoderInfo)GetProcAddress(m_hdll,"AVerSetH265VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetH265VideoEncoderInfo(HANDLE hCaptureObject, H265_VIDEOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetH265VideoEncoderInfo)GetProcAddress(m_hdll,"AVerGetH265VideoEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetAACAudioEncoderInfo(HANDLE hCaptureObject, AAC_AUDIOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerSetAACAudioEncoderInfo)GetProcAddress(m_hdll,"AVerSetAACAudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetAACAudioEncoderInfo(HANDLE hCaptureObject, AAC_AUDIOENCODER_INFO *pVideoEncoderInfo)
{
	...
	dll_Fun=(DLL_AVerGetAACAudioEncoderInfo)GetProcAddress(m_hdll,"AVerGetAACAudioEncoderInfo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureVideoSequencePause(HANDLE hCaptureObject,DWORD dwstatus)
{
	...
	dll_Fun=(DLL_AVerCaptureVideoSequencePause)GetProcAddress(m_hdll,"AVerCaptureVideoSequencePause");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCaptureSingleImageToDICOM(HANDLE hCaptureObject, LPWSTR szDICOMConfigFilePath)
{
	...
	dll_Fun=(DLL_AVerCaptureSingleImageToDICOM)GetProcAddress(m_hdll,"AVerCaptureSingleImageToDICOM");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSetVideoColorSpace(HANDLE hCaptureObject, DWORD dwColorSpace)
{
	...
	dll_Fun=(DLL_AVerSetVideoColorSpace)GetProcAddress(m_hdll,"AVerSetVideoColorSpace");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoColorSpace(HANDLE hCaptureObject, DWORD *pdwColorSpace)
{
	...
	dll_Fun=(DLL_AVerGetVideoColorSpace)GetProcAddress(m_hdll,"AVerGetVideoColorSpace");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerGetVideoColorSpaceSupported(HANDLE hCaptureObject, DWORD dwVideoSource, DWORD *pdwSupported)
{
	...
	dll_Fun=(DLL_AVerGetVideoColorSpaceSupported)GetProcAddress(m_hdll,"AVerGetVideoColorSpaceSupported");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCallbackRawVideoDataStart(HANDLE hCaptureObject, CALLBACK_VIDEO_INFO *pInfo)
{
	...
	dll_Fun=(DLL_AVerCallbackRawVideoDataStart)GetProcAddress(m_hdll,"AVerCallbackRawVideoDataStart");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerCallbackRawVideoDataStop(HANDLE hCaptureObject)
{
	...
	dll_Fun=(DLL_AVerCallbackRawVideoDataStop)GetProcAddress(m_hdll,"AVerCallbackRawVideoDataStop");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStartRecordFile(HANDLE hCaptureObject,HANDLE *phRecordObject,LPWSTR szRecordConfigFilePath)
{
	...
	dll_Fun=(DLL_AVerStartRecordFile)GetProcAddress(m_hdll,"AVerStartRecordFile");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerPauseRecordFile(HANDLE hRecordObject,DWORD dwstatus)
{
	...
	dll_Fun=(DLL_AVerPauseRecordFile)GetProcAddress(m_hdll,"AVerPauseRecordFile");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerSplitRecordFile(HANDLE hRecordObject)
{
	...
	dll_Fun=(DLL_AVerSplitRecordFile)GetProcAddress(m_hdll,"AVerSplitRecordFile");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStopRecordFile(HANDLE hRecordObject)
{
	...
	dll_Fun=(DLL_AVerStopRecordFile)GetProcAddress(m_hdll,"AVerStopRecordFile");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStartNetStreaming(HANDLE hCaptureObject,HANDLE *phNetStreamingObject,LPWSTR szNetStreamingConfigFilePath)
{
	...
	dll_Fun=(DLL_AVerStartNetStreaming)GetProcAddress(m_hdll,"AVerStartNetStreaming");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStopNetStreaming(HANDLE hNetStreamingObject)
{
	...
	dll_Fun=(DLL_AVerStopNetStreaming)GetProcAddress(m_hdll,"AVerStopNetStreaming");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerNetStreamingGetStatus(HANDLE hStreamingObject, NSStatusType eNSStatusType, ULONGLONG *pStatus)
{
	...
	dll_Fun=(DLL_AVerNetStreamingGetStatus)GetProcAddress(m_hdll,"AVerNetStreamingGetStatus");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerNetStreamingGetURL(HANDLE hStreamingObject, WCHAR *pwszURL, DWORD *pdwLength)
{
	...
	dll_Fun=(DLL_AVerNetStreamingGetURL)GetProcAddress(m_hdll,"AVerNetStreamingGetURL");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStart3DPreview(HANDLE hCaptureCH1Object,HANDLE hCaptureCH2Object,HWND hWnd,HANDLE *ph3DObject,LPWSTR sz3DConfigFilePath)
{
	...
	dll_Fun=(DLL_AVerStart3DPreview)GetProcAddress(m_hdll,"AVerStart3DPreview");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVerStop3DPreview(HANDLE h3DObject)
{
	...
	dll_Fun=(DLL_AVerStop3DPreview)GetProcAddress(m_hdll,"AVerStop3DPreview");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVer3DWindowSetVideoWindowPosition(HANDLE h3DObject,RECT rectVideoWnd)
{
	...
	dll_Fun=(DLL_AVer3DWindowSetVideoWindowPosition)GetProcAddress(m_hdll,"AVer3DWindowSetVideoWindowPosition");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
...
LONG WINAPI AVer3DWindowRepaintVideo(HANDLE h3DObject)
{
	...
	dll_Fun=(DLL_AVer3DWindowRepaintVideo)GetProcAddress(m_hdll,"AVer3DWindowRepaintVideo");
	if(dll_Fun==NULL)
	{
		return CAP_EC_UNKNOWN_ERROR;
	}
